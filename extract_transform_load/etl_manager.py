...
class ETLManager:
    ...
    def etl_grid_components_by_coordinates(self):        
        ...
        # Process the grid coordinates and components file
        self.etl_generic_processor.process_file(source_file, processed_file, columns_to_be_extracted, normalized_columns_header_names)

    # ETL surface temperature by coordinates and decades
    def etl_surface_temperature_by_coordinates_and_decades(self):     
        # Get all the surface temperature related files from the requisite source folder   
