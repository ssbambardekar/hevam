...
if __name__ == "__main__":
    ...
    etl_generic_processor.process_file(Constants.POWER_GRIDS_SOURCE_FILE, "/data/processed/test_coordinates.csv", columns_to_be_extracted, normalized_columns_header_names)